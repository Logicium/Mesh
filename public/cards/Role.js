var RoleCard = function(newData){
    ...
    self.hashtags = highlightText(newData.hashtags).css('font-size','24px').css('margin','0 auto').css('padding-top','100px');
    self.roleNamedImage = div().css(Styles.backgroundImage(newData.icon)).height('225px').css('padding-top','50px').append(self.name);
